...
class ChangeProfilePicture:
    ...
    def upload(self, picture: bytes) -> Union[utils.Response, bool]:
        ...
        try:
            ...
            return utils.Response(fbid=fbid, picture_url=picture_url)
        except AttributeError:
            return 

    def change(self, fbid: str, caption: str=None) -> Union[utils.Response, bool]:
